...
export default function EditProduct() {
  ...
  const [product,setProduct] = useState(data.find((item) => item.id.toString() === id));

  return <>
    <h1 className="text-[3rem] text-center p-5">EDIT PRODUCT</h1>
        ...
        <button className={`min-w-[%22] w-auto border border-[#593E2B] bg-[#593E2B] px-4 py-3 text-[1rem] tracking-wide text-[#FFFFFF] font-semibold uppercase rounded-lg  hover:bg-[#3d2a1d] transition-all duration-200 cursor-pointer mt-10 `} onClick={()=>{}}>Update</button>
